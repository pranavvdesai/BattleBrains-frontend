<template>
    <div class="my-auto">
        <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size+3" viewBox="0 0 21 24">
            <path id="iconmonstr-discord-1"
                ...
                transform="translate(-1)" :fill="color" fill-rule="evenodd" />
        </svg>
    </div>
</template>
