  ...
  <div class="h-screen fixed top-0 hidden md:block md:left-0 overflow-y-auto flex-row flex-nowrap overflow-hidden shadow-3xl bg-dark-300 lg:w-[22%] w-1/4 z-10 py-4 px-2 transition-all duration-300">
    <div class="xl:mx-5 lg:mx-1">
      <div class="flex mt-4">
        ...
        >
        <p class=" text-xl text-light-300">back</p>
      </div>
      <h1 class="text-white xl:text-3xl lg:text-2xl md:text-xl font-extrabold mt-16 font-mont">
        Why Web3?
      </h1>
      <div class="flex flex-col lg:flex-row mt-4">
        <h2 class="text-blue-300 mr-2 text-sm font-josefin pb-1 lg:pb-0">INTRODUCTION</h2>
    ...
    <div class="absolute bottom-0 mb-5 w-full">
      <div class="flex border-2 border-light-300 mx-8 rounded-md justify-between p-3">
        <p class="text-light-300">Test Yourself</p>
        <img
